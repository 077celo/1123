...
export function Hero() {
  const buttonNew = (
    <Button asChild className="rounded-full px-6 text-black hover:brightness-95" style={{ backgroundColor: "#AEFFDE" }}>
      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col items-center justify-center py-14 sm:py-20">
          <div className="mb-5 flex items-center gap-2">
            ...
            <p className="text-sm uppercase tracking-[0.25em]" style={{ color: "#AEFFDE", opacity: 0.8 }}>
              skitbit
            </p>
          </div>
          <h1 className="mt-3 text-center text-4xl font-extrabold tracking-tight sm:text-5xl md:text-6xl">
            <span className="block">HIGH-IMPACT</span>
            <span className="block drop-shadow-[0_0_20px_rgba(174,255,222,0.35)]" style={{ color: "#AEFFDE" }}>
              3D ANIMATION
            </span>
