      ...
      <div className="container mx-auto max-w-4xl">
        <div className="flex h-14 items-center justify-between px-6 liquid-glass-header rounded-full">
          ...
          <div className="hidden md:flex">
            <Button
              asChild
              className="text-black font-medium rounded-lg px-6 py-2.5
                         hover:shadow-md hover:scale-[1.02] hover:brightness-95
                         transition-all"
              style={{ backgroundColor: "#AEFFDE" }}
            >
            ...
            <Sheet>
              ...
              <SheetContent side="right" className="liquid-glass border-gray-800 p-0 w-64 flex flex-col">
                ...
                <div className="mt-auto border-t border-gray-800 p-4">
                  <Button
                    asChild
                    className="w-full text-black font-medium rounded-lg px-6 py-2.5
                               hover:shadow-md hover:scale-[1.02] hover:brightness-95
                               transition-all"
                    style={{ backgroundColor: "#AEFFDE" }}
                  >
