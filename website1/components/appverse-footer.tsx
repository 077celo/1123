    ...
    <section className="text-white">
      ...
      <div className="container mx-auto px-4 pt-12 sm:pt-16">
        <div className="flex justify-center">
          <Button
            asChild
            className="rounded-full px-6 py-2 text-sm font-medium text-black hover:brightness-95"
            style={{ backgroundColor: "#AEFFDE", boxShadow: "0 0 20px rgba(174,255,222,0.35)" }}
          >
      ...
      <div className="container mx-auto px-4 py-12 sm:py-16">
        <Card className="relative overflow-hidden rounded-3xl liquid-glass p-6 sm:p-10">
          <div className="relative grid items-center gap-8 md:grid-cols-2">
            {/* Left copy */}
            <div>
              <p className="mb-2 text-[11px] tracking-widest" style={{ color: "#AEFFDE" }}>
                ...
                <div className="relative aspect-[9/19] w-full overflow-hidden rounded-2xl bg-black">
                  ...
                  <div className="relative p-3">
                    ...
                    <div className="space-y-1 px-1">
                      <div className="text-5xl font-extrabold" style={{ color: "#AEFFDE" }}>
                        Approvals Made Easy
                      </div>
                  ...
                  {["Home", "Features", "Testimonials", "Pricing", "Blog", "Download"].map((item) => (
                    <li key={item}>
                      <Link
                        ...
                        onMouseEnter={(e) => (e.currentTarget.style.color = "#AEFFDE")}
